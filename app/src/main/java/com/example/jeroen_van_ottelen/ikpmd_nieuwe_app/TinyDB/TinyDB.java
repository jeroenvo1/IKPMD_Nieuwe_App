...
package com.example.jeroen_van_ottelen.ikpmd_nieuwe_app.TinyDB;
...
public class TinyDB {
    ...
    public ArrayList<Subject> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();
    	...
    	for(String jObjString : objStrings){
            Subject value  = (Subject)gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
